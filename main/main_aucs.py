...
from utils.results_helper import plot_results_histograms, save_results_data_frame, draw_results_layers, \
    get_nodes_class_dict
...
nodes_class_dict = get_nodes_class_dict(nodes_layer_centrality_dict)
...
results_data_frame['node_class'] = Series(nodes_class_dict, index=results_data_frame.index)
...
draw_results_layers(DATASET_NAME, CENTRALITY_MEASURE, multilayered_network, results_data_frame, True)
...
plot_results_histograms(DATASET_NAME, CENTRALITY_MEASURE, results_data_frame,
                        ...
                        20, 5, True)
plot_results_histograms(DATASET_NAME, CENTRALITY_MEASURE, results_data_frame, 'node_class',
                        'Node Class', 'Number of Nodes', 4, 1, True)
