...
On layer 'leisure', the connection between U18 and U76 is replaced by U79.
Thus layers facebook and lunch are still equal: U76 is present on both facebook and lunch and
U79 is also present on both facebook and lunch.

Connection Order analysis after change:
Leisure: Order 1: 0, Order 2: 2, Order 3: 2
Work: Order 1: 1, Order 2: 0, Order 3: 2
"""
...
multi_layered_network = read("{0}/resources/aucs_U18_test_1.txt".format(project_root_path))
